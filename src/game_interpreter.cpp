...
bool Game_Interpreter::CommandPlaySound(lcf::rpg::EventCommand const& com) { // code 11550
	...
	//if (Main_Data::game_switches->GetInt(0482) == 1)
...
//	Garenburg Patch: Achievement Processing
bool Game_Interpreter::CommandEndEventProcessing(lcf::rpg::EventCommand const& /* com */) { // code 12310
	//////////////////////////////////////////////////////////////
	//	Steamshim Garenburg Achievement Handling
	const STEAMSHIM_Event* e;
	std::string variableName;

	if (Main_Data::game_switches->Get(202)) {
		//	Set Achievement - Green
		STEAMSHIM_setAchievement("WOODS_GREEN", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(203)) {
		//	Set Achievement - Blue
		STEAMSHIM_setAchievement("WOODS_BLUE", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(204)) {
		//	Set Achievement - Black
		STEAMSHIM_setAchievement("WOODS_BLACK", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(205)) {
		//	Set Achievement - GRAY
		STEAMSHIM_setAchievement("WOODS_GRAY", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(206)) {
		//	Set Achievement - Tear Drops
		STEAMSHIM_setAchievement("WOODS_TEAR_DROPS", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(207)) {
		//	Set Achievement - Orange
		STEAMSHIM_setAchievement("WOODS_ORANGE", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(208)) {
		//	Set Achievement - RUSSELL LIVES
		STEAMSHIM_setAchievement("WOODS_RUSSELL_LIVES", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(209)) {
		//	Set Achievement - Red
		STEAMSHIM_setAchievement("WOODS_RED", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(210)) {
		//	Set Achievement - Yellow
		STEAMSHIM_setAchievement("WOODS_YELLOW", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(211)) {
		//	Set Achievement - The Golden Chain
		STEAMSHIM_setAchievement("WOODS_NECKLACE", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(212)) {
		//	Set Achievement - White
		STEAMSHIM_setAchievement("WOODS_WHITE", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(213)) {
		//	Set Achievement - The Hammer
		STEAMSHIM_setAchievement("WOODS_HAMMER", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(214)) {
		//	Set Achievement - Lunacy
		STEAMSHIM_setAchievement("WOODS_LUNACY", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(215)) {
		//	Set Achievement - Lime Green
		STEAMSHIM_setAchievement("WOODS_LIME", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(216)) {
		//	Set Achievement - No Body
		STEAMSHIM_setAchievement("WOODS_NO_BODY", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(217)) {
		//	Set Achievement - No Body Knows
		STEAMSHIM_setAchievement("WOODS_RISK_NO_BODY", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(218)) {
		//	Set Achievement - Purple
		STEAMSHIM_setAchievement("WOODS_PURPLE", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(219)) {
		//	Set Achievement - Denial
		STEAMSHIM_setAchievement("WOODS_GOOD", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(220)) {
		//	Set Achievement - Never Enough
		STEAMSHIM_setAchievement("WOODS_NEUTRAL", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(222)) {
		//	Set Achievement - Golden Drop of Happiness
		STEAMSHIM_setAchievement("WOODS_BAD", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(223)) {
		//	Set Achievement - Bleeding
		STEAMSHIM_setAchievement("WOODS_BLEEDING", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(224)) {
		//	Set Achievement - Broken
		STEAMSHIM_setAchievement("WOODS_BROKEN", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(225)) {
		//	Set Achievement - Drowned
		STEAMSHIM_setAchievement("WOODS_DROWNED", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(226)) {
		//	Set Achievement - Burning
		STEAMSHIM_setAchievement("WOODS_BURNING", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(227)) {
		//	Set Achievement - Ill
		STEAMSHIM_setAchievement("WOODS_ILL", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(228)) {
		//	Set Achievement - Second Chance
		STEAMSHIM_setAchievement("WOODS_SPAWN", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(229)) {
		//	Set Achievement - Limping
		STEAMSHIM_setAchievement("WOODS_LIMPING", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(230)) {
		//	Set Achievement - Trapped
		STEAMSHIM_setAchievement("WOODS_TRAPPED", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(231)) {
		//	Set Achievement - Obedient
		STEAMSHIM_setAchievement("WOODS_OBEDIENT", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(232)) {
		//	Set Achievement - Mourning
		STEAMSHIM_setAchievement("WOODS_MOURNING", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(233)) {
		//	Set Achievement - SHE'S DEAD
		STEAMSHIM_setAchievement("WOODS_RISK_PURPLE", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(234)) {
		//	Set Achievement - Dice Roll
		STEAMSHIM_setAchievement("WOODS_RISK_GOOD", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(235)) {
		//	Set Achievement - Snake Eyes
		STEAMSHIM_setAchievement("WOODS_RISK_NEUTRAL", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(236)) {
		//	Set Achievement - Lucky You
		STEAMSHIM_setAchievement("WOODS_RISK_BAD", 1);
		STEAMSHIM_storeStats();
	}

	if (Main_Data::game_switches->Get(237)) {
		//	Set Achievement - Happy As Can Be
		STEAMSHIM_setAchievement("WOODS_HAPPY", 1);
		STEAMSHIM_storeStats();
	}
